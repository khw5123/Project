...
def main():
    ...
    for _ in range(epoch):
        W1, W2 = deltaSGDBackpropagation(W1, W2, X, D) # 학습
    # Test
...
def deltaSGDBackpropagation(W, X, D, hiddenLayerCount, hiddenNodeCount):
    alpha = 0.9 # 학습률
...
def main():
    ...
    epoch = 10000 # 학습 횟수
    for _ in range(epoch):
        deltaSGDBackpropagation(W, X, D, hiddenLayerCount, hiddenNodeCount) # 학습
    # Test
